                    ...
                    {slides.length === 0 ? (
                        <div className="flex-1 flex items-center justify-center">
                            <div className="text-center max-w-lg">
                                <h2 className="text-3xl font-semibold text-gray-900 mb-4">Welcome to SlidePilot</h2>
                                <p className="text-lg text-gray-600 mb-8">Your AI-powered presentation editor</p>
                                <p className="text-gray-500 mb-8">Click 'Open Presentation' to load a PowerPoint file and see the slide parsing in action.</p>
                            </div>
                        </div>
                    ) : (
